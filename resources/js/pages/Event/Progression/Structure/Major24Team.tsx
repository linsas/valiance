...
export default function Major24Team({ structure }: {
	...
	const c00 = challengersOpeningRound.filter(m => m.significanceKey === 'c00')

	const challengersRound2 = structure.getRoundMatchupsOrDefault(2)
	const c01 = challengersRound2.filter(m => m.significanceKey === 'c01')
	const c10 = challengersRound2.filter(m => m.significanceKey === 'c10')

	const challengersRound3 = structure.getRoundMatchupsOrDefault(3)
	const c02 = challengersRound3.filter(m => m.significanceKey === 'c02')
	const c11 = challengersRound3.filter(m => m.significanceKey === 'c11')
	const c20 = challengersRound3.filter(m => m.significanceKey === 'c20')

	const challengersRound4 = structure.getRoundMatchupsOrDefault(4)
	const c21 = challengersRound4.filter(m => m.significanceKey === 'c21')
	const c12 = challengersRound4.filter(m => m.significanceKey === 'c12')

	const challengersFinalRound = structure.getRoundMatchupsOrDefault(5)
	const c22 = challengersFinalRound.filter(m => m.significanceKey === 'c22')


	const legendsOpeningRound = structure.getRoundMatchupsOrDefault(6)
	const l00 = legendsOpeningRound.filter(m => m.significanceKey === 'l00')

	const legendsRound2 = structure.getRoundMatchupsOrDefault(7)
	const l01 = legendsRound2.filter(m => m.significanceKey === 'l01')
	const l10 = legendsRound2.filter(m => m.significanceKey === 'l10')

	const legendsRound3 = structure.getRoundMatchupsOrDefault(8)
	const l02 = legendsRound3.filter(m => m.significanceKey === 'l02')
	const l11 = legendsRound3.filter(m => m.significanceKey === 'l11')
	const l20 = legendsRound3.filter(m => m.significanceKey === 'l20')

	const legendsRound4 = structure.getRoundMatchupsOrDefault(9)
	const l21 = legendsRound4.filter(m => m.significanceKey === 'l21')
	const l12 = legendsRound4.filter(m => m.significanceKey === 'l12')

	const legendsFinalRound = structure.getRoundMatchupsOrDefault(10)
	const l22 = legendsFinalRound.filter(m => m.significanceKey === 'l22')
